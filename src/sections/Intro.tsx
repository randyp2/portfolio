...
const Intro:React.FC = () => {
    ...
    return (
        <motion.div className="flex flex-row justify-center items-center w-full h-screen gap-20"
        initial= {{ scale: 0.6, opacity: 0 }}
            ...
            <div>
                <span className="text-[200px] text-white drop-shadow-[0_0_3px_white]"><FaArrowRight /></span>
            </div>
        </motion.div>
    );
}
