  ...
  ({
    ...
    const handleMove = useCallback(
      (e?: MouseEvent | { x: number; y: number }) => {
        ...
        // Throttle updates to ~20fps to reduce performance impact
        const now = performance.now();
        const timeSinceLastUpdate = now - lastUpdateTime.current;
        if (timeSinceLastUpdate < 50) return; // ~20fps
        ...
        animationFrameRef.current = requestAnimationFrame(() => {
          ...
          // Use CSS transition instead of animate() for better performance
          ...
          style={
            {
              ...
              "--gradient":
                ...
                repeating-conic-gradient(
                  ...
                  rgba(200,200,200,0.7) calc(25% / var(--repeating-conic-gradient-times)),
                  rgba(255,255,255,0.9) calc(50% / var(--repeating-conic-gradient-times)),
                  rgba(200,200,200,0.7) calc(75% / var(--repeating-conic-gradient-times)),
