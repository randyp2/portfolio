...
const Navbar: React.FC = () => {
  ...
  const handleNavClick = (sectionId: SectionId) => {
    if (isDesktop) {
      ...
      // Wait for menu closing animation to finishr rendering
      setTimeout(() => {
        const mobileId = ["languages", "tools", "frameworks"].includes(
          sectionId,
        )
          ? "skills"
          : sectionId;
        ...
        if (el) {
          const navbarOffset: number = 72; // Fixed height
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 lg:absolute lg:left-8">
          ...
          <span className="hidden lg:block text-white/90 font-bold tracking-wide">
            Randy Pahang II
          </span>
        </div>

        {/* Center: Name on mobile only */}
        <span className="lg:hidden text-white/90 font-bold tracking-wide text-sm">
          Randy Pahang II
        </span>
        ...
        <div className="hidden lg:flex gap-6">
          ...
          <div className="relative group">
            ...
            <div
              className="absolute top-full left-0 mt-2 py-2 min-w-[160px] rounded-lg
