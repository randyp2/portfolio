...
const Ball: React.FC<BallProps> = ({ physics, viewportCenterX, cameraX, onLaunch, isLaunching }) => {
      ...
      <>
        <motion.div
          ...
          style={{
            ...
            left: `${ballScreenX - BALL_RADIUS}px`,
            top: `${ballScreenY - BALL_RADIUS}px`,
          }}
