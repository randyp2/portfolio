...
const Footer: React.FC = () => {
  return (
    <footer className="fixed bottom-3 left-3 right-3 z-40 mx-auto max-w-[1240px] border border-[var(--terminal-line)] bg-black/90 px-4 py-2.5 shadow-[0_0_24px_rgba(46,212,101,0.08)] backdrop-blur-md">
